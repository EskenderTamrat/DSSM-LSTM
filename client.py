...
from service_spec.LSTM_pb2 import Query
from service_spec.LSTM_pb2_grpc import ReplyStub

if __name__ == "__main__":
	
	# open a gRPC channel
	channel = grpc.insecure_channel('localhost:8001')
	stub = ReplyStub(channel)
	...
	response = stub.semantic_modeling(Query(train_file = args.train_file, validation_file = args.validation_file, query_wf = args.query_wf, answer_wf = args.answer_wf))	
